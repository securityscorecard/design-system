...
export function createBooleanType(init: {
  jsDoc: string | undefined;
}): BooleanType {
  return {
    type: 'boolean',
...
export function createFunctionType(init: {
  jsDoc: string | undefined;
}): FunctionType {
  return {
    type: 'FunctionNode',
...
export function createNumericType(init: {
  jsDoc: string | undefined;
}): NumericType {
  return {
    type: 'NumericNode',
...
export function createObjectType(init: {
  jsDoc: string | undefined;
}): ObjectType {
  return {
    type: 'ObjectNode',
...
export function createStringType(init: {
  jsDoc: string | undefined;
}): StringType {
  return {
    type: 'StringNode',
...
export function createUndefinedType(init: {
  jsDoc: string | undefined;
}): UndefinedType {
  return {
    type: 'UndefinedNode',
