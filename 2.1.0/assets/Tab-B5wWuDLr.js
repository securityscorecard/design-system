import{j as c}from"./jsx-runtime-Cw0GR0a5.js";import{R as p}from"./index-CTjT7uj6.js";import{P as e}from"./index-BRV0Se7Z.js";import"./Surface-CvF-S7pg.js";import"./Padbox-CsIyVOa3.js";import"./Stack-vWwwEz_d.js";import{I as q}from"./Inline-CNottUT6.js";import"./Cluster-BOKWm1iB.js";import{j as _,S as n,e as x,P as h}from"./space-BY85GhUc.js";import{a as w,B as P,b as E}from"./BaseTabLabel-CA2UX4fK.js";import{r as S}from"./require-router-link-EREg1Bbm.js";const t=w,b=({selectedValue:m,selectedPatternMatcher:i=x,children:a,onSelectTab:l,variant:r=t.underline,isExpanded:u=!1})=>c.jsx(P,{$isExpanded:u,$variant:r,className:_,paddingSize:r===t.segmented?n.xs:n.none,children:c.jsx(q,{gap:r===t.segmented?n.sm:r===t.underline?n.none:n.lg,role:"tablist",stretch:u?"all":0,children:p.Children.map(a,s=>p.isValidElement(s)?p.cloneElement(s,{key:s.props.value,__variant:r,__isExpanded:u,__isSelected:i(s.props.value,m),__onSelectTab:l}):null)})});b.propTypes={selectedValue:e.oneOfType([e.string,e.number]).isRequired,children:e.arrayOf(e.node).isRequired,variant:e.oneOf(Object.values(t)),selectedPatternMatcher:e.func,isExpanded:e.bool,onSelectTab:e.func};const M=b;b.__docgenInfo={description:"",methods:[],displayName:"Tabs",props:{margin:{required:!1,tsType:{name:"union",raw:`| 'none'
| number
| {
    vertical?: number;
    horizontal?: number;
