...
`,e.jsx(t.p,{children:"Notice the Current level has lighter color - this one doesn't have 'to' or 'href' defined, so it's inactive."})]})}function y(n={}){const{wrapper:t}={...l(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(r,{...n})}):r(n)}export{y as default};
//# sourceMappingURL=implementingBreadcrumbs-B525CqD6.js.map
