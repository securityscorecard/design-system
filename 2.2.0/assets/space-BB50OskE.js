import{j as p}from"./jsx-runtime-Cw0GR0a5.js";import{useMDXComponents as pt}from"./index-DSkyVWTJ.js";import{au as C,ar as oe,I as J,av as E,X as Ht,ae as Lt}from"./index-CCCfPMbC.js";import{a as ut,r as w,R as O}from"./index-CTjT7uj6.js";import{_ as se,R as He,U as zt,O as It,e as Ft,s as re}from"./space-1LtLrmuu.js";import"./DSProvider-IYcK3cWD.js";import"./DSThemeOverride-BduN1ykm.js";import"./index-DFvsTZbx.js";import{t as Dt}from"./theme-Cr_I21Pv.js";import"./iframe-B4dJUhKJ.js";import"../sb-preview/runtime.js";import"./index-DIVhMF2i.js";import"./extends-CF3RwP-h.js";import"./isNativeReflectConstruct-lfp1ZYuW.js";import"./inheritsLoose-B6jfs0L0.js";import"./setPrototypeOf-DgZC2w_0.js";import"./index-MJJVguu6.js";import"./index-DrFu-skq.js";import"./prop-DG2n0FAQ.js";import"./colors-CyEChGtp.js";var Ut=function(){function i(e,t){this.xf=t,this.n=e}return i.prototype["@@transducer/init"]=He.init,i.prototype["@@transducer/result"]=He.result,i.prototype["@@transducer/step"]=function(e,t){return this.n>0?(this.n-=1,e):this.xf["@@transducer/step"](e,t)},i}(),Vt=se(function(e,t){return new Ut(e,t)}),Yt=se(zt(["drop"],Vt,function(e,t){return It(Math.max(0,e),1/0,t)})),Wt=se(function(e,t){return Yt(e>=0?t.length-e:0,t)}),Xt=se(function(i,e){return Ft(Wt(i.length,e),i)});/**
 * @license
...
`)}}const At=i=>[Math.trunc(255*i.r),Math.trunc(255*i.g),Math.trunc(255*i.b)],Ti=i=>{const[e,t,o]=At(i);return"#"+((1<<24)+(e<<16)+(t<<8)+o).toString(16).slice(1)},St=({property:i,value:e})=>`${i}: ${e};`;var Ni=function(i,e,t,o){function s(r){return r instanceof t?r:new t(function(n){n(r)})}return new(t||(t=Promise))(function(r,n){function c(l){try{d(o.next(l))}catch(h){n(h)}}function a(l){try{d(o.throw(l))}catch(h){n(h)}}function d(l){l.done?r(l.value):s(l.value).then(c,a)}d((o=o.apply(i,e||[])).next())})};const Re=i=>Ni(void 0,void 0,void 0,function*(){yield navigator.clipboard.writeText(i)}),Bi=({node:i,onClose:e})=>{if(!i)return null;const t=new Pi(i),o=s=>s.stopPropagation();return y`
    <div
  ...
  `},Ri=i=>{const e=()=>Re(i.getStyleSheet()),t=i.getStyles();return y`<div class="inspector-section">
  ...
  </div>`},ji=i=>{const{property:e,value:t,color:o}=i;let s=null;switch(e){case"background":case"fill":case"border":case"box-shadow":case"color":s=y`<span
        class="color-preview"
...
`,et=({node:i,selected:e=!1,computedThickness:t,onClick:o})=>{const{x:s,y:r,width:n,height:c}=i.absoluteBoundingBox,a="cornerRadius"in i&&i.cornerRadius?{topLeft:i.cornerRadius,topRight:i.cornerRadius,bottomRight:i.cornerRadius,bottomLeft:i.cornerRadius}:"rectangleCornerRadii"in i&&i.rectangleCornerRadii?{topLeft:i.rectangleCornerRadii[0],topRight:i.rectangleCornerRadii[1],bottomRight:i.rectangleCornerRadii[2],bottomLeft:i.rectangleCornerRadii[3]}:{topLeft:0,topRight:0,bottomRight:0,bottomLeft:0},d=t/2,l=(u,m)=>`M${u},${m}`,h=(u,m)=>`L${u},${m}`,f=(u,m,$)=>`A${u},${u} 0 0 1 ${m},${$}`,g=[l(a.topLeft+d,d),h(n-a.topRight,d),f(a.topRight-d,n-d,a.topRight),h(n-d,c-a.bottomRight),f(a.bottomRight-d,n-a.bottomRight,c-d),h(a.bottomLeft,c-d),f(a.bottomLeft-d,d,c-a.bottomLeft),h(d,a.topLeft),f(a.topLeft-d,a.topLeft,d),"Z"].join(" ");return A`
    <path
      ...
      @click=${o}
    />
  `},Hi=({nodeSize:{x:i,y:e,width:t,height:o},offsetX:s,offsetY:r,reverseScale:n})=>{const c={top:`${r+e+o}px`,left:`${s+i+t/2}px`,transform:`translateX(-50%) scale(${n}) translateY(0.25em)`};return y`
...
`,Di=i=>{if(!i||!i.link||i.link===void 0||i.link==="undefined")return null;const{link:e,timestamp:t,fileName:o}=i;return y`<a
    class="figma-footer"
    target="_blank"
    rel="noopener"
    title="Open in Figma"
