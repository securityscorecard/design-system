 ...
 */const xt="important",vi=" !"+xt,te=gi(class extends mi{constructor(i){var e;if(super(i),i.type!==fi.ATTRIBUTE||i.name!=="style"||((e=i.strings)===null||e===void 0?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(i){return Object.keys(i).reduce((e,t)=>{const o=i[t];return o==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${o};`},"")}update(i,[e]){const{style:t}=i.element;if(this.ht===void 0){this.ht=new Set;for(const o in e)this.ht.add(o);return this.render(e)}this.ht.forEach(o=>{e[o]==null&&(this.ht.delete(o),o.includes("-")?t.removeProperty(o):t[o]="")});for(const o in e){const s=e[o];if(s!=null){this.ht.add(o);const r=typeof s=="string"&&s.endsWith(vi);o.includes("-")||r?t.setProperty(o,r?s.slice(0,-11):s,r?xt:""):t[o]=s}}return B}});function Ge(i){return{top:i.y,right:i.x+i.width,bottom:i.y+i.height,left:i.x}}function yi(i,e){const t=Ge(i),o=Ge(e),s=!(t.top>o.bottom||t.bottom<o.top),r=!(t.left>o.right||t.right<o.left);if(r&&s){const l={x:(Math.max(t.left,o.left)+Math.min(t.right,o.right))/2,y:(Math.max(t.top,o.top)+Math.min(t.bottom,o.bottom))/2};return[{points:[{x:t.left,y:l.y},{x:o.left,y:l.y}]},{points:[{x:t.right,y:l.y},{x:o.right,y:l.y}]},{points:[{y:t.top,x:l.x},{y:o.top,x:l.x}]},{points:[{y:t.bottom,x:l.x},{y:o.bottom,x:l.x}]}]}const n=t.left>o.right,c=t.top>o.bottom,a={x:i.x+i.width/2,y:i.y+i.height/2};return[r?null:{points:[{x:n?t.left:t.right,y:a.y},{x:n?o.right:o.left,y:a.y}],bisector:s?void 0:[{x:n?o.right:o.left,y:a.y},{x:n?o.right:o.left,y:c?o.bottom:o.top}]},s?null:{points:[{y:c?t.top:t.bottom,x:a.x},{y:c?o.bottom:o.top,x:a.x}],bisector:r?void 0:[{y:c?o.bottom:o.top,x:a.x},{y:c?o.bottom:o.top,x:n?o.right:o.left}]}].filter(l=>!!l)}function Ee(i){return Math.round(i*100)/100}function wt(i,e){return[...qe(i),...qe(e)]}function qe(i){return i?i instanceof Array?i:[i]:[]}var bi=function(i,e,t,o){var s=arguments.length,r=s<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,o);else for(var c=i.length-1;c>=0;c--)(n=i[c])&&(r=(s<3?n(r):s>3?n(e,t,r):n(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r};const $i=i=>{class e extends i{constructor(...o){super(...o),this.selectedNode=null}updated(o){super.updated(o),o.has("selectedNode")&&this.dispatchEvent(new CustomEvent("nodeselect",{detail:{selectedNode:this.selectedNode}}))}}return bi([_({attribute:!1})],e.prototype,"selectedNode",void 0),e};function Z(i){return i.touches.length===0||i.touches.length>2}function xi(i,e){return Math.sqrt(Math.pow(i.x-e.x,2)+Math.pow(i.y-e.y,2))}const wi=i=>class extends i{constructor(...t){super(...t),this.previousTouches=null,this.addEventListener("touchstart",o=>{Z(o)||(o.preventDefault(),this.previousTouches=o.touches)}),this.addEventListener("touchend",o=>{Z(o)||(o.preventDefault(),this.previousTouches=null)}),this.addEventListener("touchcancel",o=>{Z(o)||(o.preventDefault(),this.previousTouches=null)}),this.addEventListener("touchmove",o=>{if(Z(o))return;const s=Array.from(this.previousTouches||[]),r=Array.from(o.touches);if(this.previousTouches=o.touches,!(r.length!==s.length||!r.every(n=>s.some(c=>c.identifier===n.identifier)))){if(r.length===1){this.onTouchPan({x:r[0].pageX-s[0].pageX,y:r[0].pageY-s[0].pageY});return}this.onTouchPinch(xi({x:r[0].pageX,y:r[0].pageY},{x:s[0].pageX,y:s[0].pageY}))}})}get isTouching(){return!!(this.previousTouches&&this.previousTouches.length>0)}onTouchPan(t){}onTouchPinch(t){}};var D=function(i,e,t,o){var s=arguments.length,r=s<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,o);else for(var c=i.length-1;c>=0;c--)(n=i[c])&&(r=(s<3?n(r):s>3?n(e,t,r):n(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r},S=function(i,e,t,o){if(t==="a"&&!o)throw new TypeError("Private accessor was defined without a getter");if(typeof e=="function"?i!==e||!o:!e.has(i))throw new TypeError("Cannot read private member from an object whose class did not declare it");return t==="m"?o:t==="a"?o.call(i):o?o.value:e.get(i)},Ke=function(i,e,t,o,s){if(o==="m")throw new TypeError("Private method is not writable");if(o==="a"&&!s)throw new TypeError("Private accessor was defined without a setter");if(typeof e=="function"?i!==e||!s:!e.has(i))throw new TypeError("Cannot write private member to an object whose class did not declare it");return o==="a"?s.call(i,t):s?s.value=t:e.set(i,t),t};const _i=i=>{var e,t,o,s,r;class n extends wi(i){constructor(...a){super(...a),this.panX=0,this.panY=0,this.scale=1,this.zoomSpeed=500,this.panSpeed=500,e.set(this,!1),t.set(this,(l,h)=>{this.panX+=l/this.scale/window.devicePixelRatio,this.panY+=h/this.scale/window.devicePixelRatio}),o.set(this,l=>{l.code==="Space"&&!S(this,e,"f")&&(Ke(this,e,!0,"f"),document.body.style.cursor="grab")}),s.set(this,l=>{l.code==="Space"&&S(this,e,"f")&&(Ke(this,e,!1,"f"),document.body.style.cursor="auto")}),r.set(this,()=>{document.addEventListener("keyup",S(this,s,"f")),document.addEventListener("keydown",S(this,o,"f"))}),this.addEventListener("wheel",l=>{if(this.isMovable)if(l.preventDefault(),l.ctrlKey){let{deltaY:h}=l;l.deltaMode===1&&(h*=15);const f=this.scale;this.scale*=1-h/((1e3-this.zoomSpeed)*.5);const g=l.offsetX-this.offsetWidth/2,p=l.offsetY-this.offsetHeight/2;this.panX+=g/this.scale-g/f,this.panY+=p/this.scale-p/f}else{const h=this.panSpeed*.002;this.panX-=l.deltaX*h/this.scale,this.panY-=l.deltaY*h/this.scale}},{passive:!1});let d=1;this.addEventListener("gesturestart",l=>{l.preventDefault(),d=this.scale}),this.addEventListener("gesturechange",l=>{const h=l;h.preventDefault(),this.scale=d*h.scale}),this.addEventListener("pointermove",l=>{l.buttons&4&&(l.preventDefault(),S(this,t,"f").call(this,l.movementX,l.movementY))}),S(this,r,"f").call(this),this.onmousedown=()=>{S(this,e,"f")&&(document.body.style.cursor="grabbing",this.onmousemove=({movementX:l,movementY:h})=>{S(this,t,"f").call(this,l,h)},this.onmouseup=()=>{document.body.style.cursor="grab",this.onmousemove=null,this.onmouseup=null})}}get isMovable(){return!0}get canvasTransform(){return[`scale(${this.scale})`,`translate(${this.panX}px, ${this.panY}px)`]}disconnectedCallback(){document.removeEventListener("keyup",S(this,s,"f")),document.removeEventListener("keydown",S(this,o,"f")),super.disconnectedCallback()}updated(a){super.updated(a),a.has("scale")&&this.dispatchEvent(new CustomEvent("scalechange",{detail:{scale:this.scale}})),(a.has("panX")||a.has("panY"))&&this.dispatchEvent(new CustomEvent("positionchange",{detail:{x:this.panX,y:this.panY}}))}onTouchPan(a){this.panX+=a.x/this.scale,this.panY+=a.y/this.scale}onTouchPinch(a){this.scale*=1-a/1e3}}return e=new WeakMap,t=new WeakMap,o=new WeakMap,s=new WeakMap,r=new WeakMap,D([_({attribute:!1})],n.prototype,"panX",void 0),D([_({attribute:!1})],n.prototype,"panY",void 0),D([_({attribute:!1})],n.prototype,"scale",void 0),D([_({type:Number,attribute:"zoom-speed"})],n.prototype,"zoomSpeed",void 0),D([_({type:Number,attribute:"pan-speed"})],n.prototype,"panSpeed",void 0),n},Ei=({guide:i,reverseScale:e})=>{const t=Math.abs(i.points[0].x-i.points[1].x),o=Math.abs(i.points[0].y-i.points[1].y);return t===0&&o===0?null:A`
  ...
  `},Je=new Map,Si=({node:i,distanceTo:e,reverseScale:t,fontSize:o})=>{const s=i.id+`
`+e.id;let r=Je.get(s);return r||(r=yi(i.absoluteBoundingBox,e.absoluteBoundingBox),Je.set(s,r)),[...r.map(n=>Ei({guide:n,reverseScale:t})),...r.map(n=>Ai({guide:n,reverseScale:t,fontSize:o}))]},Ci=N`
  .distance-line {
    shape-rendering: geometricPrecision;
    fill: none;
    opacity: 0;
...
`)}}const Et=i=>[Math.trunc(255*i.r),Math.trunc(255*i.g),Math.trunc(255*i.b)],ji=i=>{const[e,t,o]=Et(i);return"#"+((1<<24)+(e<<16)+(t<<8)+o).toString(16).slice(1)},At=({property:i,value:e})=>`${i}: ${e};`;var Oi=function(i,e,t,o){function s(r){return r instanceof t?r:new t(function(n){n(r)})}return new(t||(t=Promise))(function(r,n){function c(l){try{d(o.next(l))}catch(h){n(h)}}function a(l){try{d(o.throw(l))}catch(h){n(h)}}function d(l){l.done?r(l.value):s(l.value).then(c,a)}d((o=o.apply(i,e||[])).next())})};const Ne=i=>Oi(void 0,void 0,void 0,function*(){yield navigator.clipboard.writeText(i)}),Hi=({node:i,onClose:e})=>{if(!i)return null;const t=new Ri(i),o=s=>s.stopPropagation();return y`
  ...
  `},Li=i=>{const e=()=>Ne(i.getStyleSheet()),t=i.getStyles();return y`<div class="inspector-section">
  ...
  </div>`},zi=i=>{const{property:e,value:t,color:o}=i;let s=null;switch(e){case"background":case"fill":case"border":case"box-shadow":case"color":s=y`<span
        class="color-preview"
...
`,Qe=({node:i,selected:e=!1,computedThickness:t,onClick:o})=>{const{x:s,y:r,width:n,height:c}=i.absoluteBoundingBox,a="cornerRadius"in i&&i.cornerRadius?{topLeft:i.cornerRadius,topRight:i.cornerRadius,bottomRight:i.cornerRadius,bottomLeft:i.cornerRadius}:"rectangleCornerRadii"in i&&i.rectangleCornerRadii?{topLeft:i.rectangleCornerRadii[0],topRight:i.rectangleCornerRadii[1],bottomRight:i.rectangleCornerRadii[2],bottomLeft:i.rectangleCornerRadii[3]}:{topLeft:0,topRight:0,bottomRight:0,bottomLeft:0},d=t/2,l=(p,m)=>`M${p},${m}`,h=(p,m)=>`L${p},${m}`,f=(p,m,$)=>`A${p},${p} 0 0 1 ${m},${$}`,g=[l(a.topLeft+d,d),h(n-a.topRight,d),f(a.topRight-d,n-d,a.topRight),h(n-d,c-a.bottomRight),f(a.bottomRight-d,n-a.bottomRight,c-d),h(a.bottomLeft,c-d),f(a.bottomLeft-d,d,c-a.bottomLeft),h(d,a.topLeft),f(a.topLeft-d,a.topLeft,d),"Z"].join(" ");return A`
    <path
      ...
      @click=${o}
    />
  `},Ii=({nodeSize:{x:i,y:e,width:t,height:o},offsetX:s,offsetY:r,reverseScale:n})=>{const c={top:`${r+e+o}px`,left:`${s+i+t/2}px`,transform:`translateX(-50%) scale(${n}) translateY(0.25em)`};return y`
...
`,Ae=1e3,Se=60*Ae,Ce=60*Se,W=24*Ce,et=7*W,tt=30*W,it=365*W,Ui=[{gte:it,divisor:it,unit:"year"},{gte:tt,divisor:tt,unit:"month"},{gte:et,divisor:et,unit:"week"},{gte:W,divisor:W,unit:"day"},{gte:Ce,divisor:Ce,unit:"hour"},{gte:Se,divisor:Se,unit:"minute"},{gte:30*Ae,divisor:Ae,unit:"seconds"},{gte:0,divisor:1,text:"just now"}],ot=i=>(typeof i=="object"?i:new Date(i)).getTime(),Vi=(i,e=Date.now(),t=new Intl.RelativeTimeFormat(void 0,{numeric:"auto"}))=>{const s=ot(e)-ot(i),r=Math.abs(s);for(const n of Ui)if(r>=n.gte){const c=Math.round(Math.abs(s)/n.divisor),a=s<0,d=n.unit;return d?t.format(a?c:-c,d):n.text}},Yi=N`
  .figma-footer {
    flex: 0;
    z-index: calc(var(--z-index) + 1);
...
`,Wi=i=>{if(!i||!i.link||i.link===void 0||i.link==="undefined")return null;const{link:e,timestamp:t,fileName:o}=i;return y`<a
    class="figma-footer"
    target="_blank"
    rel="noopener"
    title="Open in Figma"
    href="${e}"
  >
    <span class="figma-footer--icon"> ${Ti()} </span>
        ...
        "
          >
            ${Object.entries(this.__images).map(([g,p])=>{var m;const $=x(this,r,"f").call(this,g);if(!$||!("absoluteBoundingBox"in $)||!(!((m=x(this,t,"f"))===null||m===void 0)&&m[$.id]))return null;const v=x(this,t,"f")[$.id];return y`
                ...
                />
              `})}
            ${this.selectedNode&&Ii({nodeSize:this.selectedNode.absoluteBoundingBox,offsetX:-a.x,offsetY:-a.y,reverseScale:d})}
            ${A`
            <svg
              class="guides"
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Gi=new Set(["children","localName","ref","style","className"]),rt=new WeakMap,qi=(i,e,t,o,s)=>{const r=s==null?void 0:s[e];r===void 0||t===o?t==null&&e in HTMLElement.prototype?i.removeAttribute(e):i[e]=t:((n,c,a)=>{let d=rt.get(n);d===void 0&&rt.set(n,d=new Map);let l=d.get(c);a!==void 0?l===void 0?(d.set(c,l={handleEvent:a}),n.addEventListener(c,l)):l.handleEvent=a:l!==void 0&&(d.delete(c),n.removeEventListener(c,l))})(i,r,t)},Ki=(i,e)=>{typeof i=="function"?i(e):i.current=e};function Mt(i=window.React,e,t,o,s){let r,n,c;if(e===void 0){const g=i;({tagName:n,elementClass:c,events:o,displayName:s}=g),r=g.react}else r=i,c=t,n=e;const a=r.Component,d=r.createElement,l=new Set(Object.keys(o??{}));class h extends a{constructor(){super(...arguments),this.o=null}t(p){if(this.o!==null)for(const m in this.i)qi(this.o,m,this.props[m],p?p[m]:void 0,o)}componentDidMount(){var p;this.t(),(p=this.o)===null||p===void 0||p.removeAttribute("defer-hydration")}componentDidUpdate(p){this.t(p)}render(){const{_$Gl:p,...m}=this.props;this.h!==p&&(this.u=v=>{p!==null&&Ki(p,v),this.o=v,this.h=p}),this.i={};const $={ref:this.u};for(const[v,ce]of Object.entries(m))Gi.has(v)?$[v==="className"?"class":v]=ce:l.has(v)||v in c.prototype?this.i[v]=ce:$[v]=ce;return $.suppressHydrationWarning=!0,d(n,$)}}h.displayName=s??c.name;const f=r.forwardRef((g,p)=>d(h,{...g,_$Gl:p},g==null?void 0:g.children));return f.displayName=h.displayName,f}const Ji=Mt(ut,"figspec-frame-viewer",ne,{onNodeSelect:"nodeselect",onPositionChange:"positionchange",onScaleChange:"scalechange"}),Qi=Mt(ut,"figspec-file-viewer",ae,{onNodeSelect:"nodeselect",onPositionChange:"positionchange",onScaleChange:"scalechange"});var eo={},to=Object.defineProperty,Re=(i,e)=>()=>(i&&(e=i(i=0)),e),io=(i,e)=>{for(var t in e)to(i,t,{get:e[t],enumerable:!0})},Pt,nt,at,lt,le=Re(()=>{Pt=({config:i,defer:e=!1})=>{let[t,o]=w.useState(e?void 0:i.url),[s,r]=w.useState(!1);return w.useEffect(()=>{if(!e)return;let n=requestAnimationFrame(()=>{o(i.url)});return()=>cancelAnimationFrame(n)},[e,i.url]),w.useEffect(()=>{r(!1)},[t]),E("div",{css:nt},!s&&E(J,{css:at},"Loading..."),E("iframe",{css:lt,src:t,allowFullScreen:i.allowFullscreen,onLoad:()=>r(!0)}))},nt=C`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`;je();le();C`
  ...
  align-items: center;
`;le();w.lazy(()=>Promise.resolve().then(()=>(jt(),Bt)));var so=oe.div(({theme:i})=>`
  font-family: ${i.typography.fonts.base};
  font-size: ${i.typography.size.s3}px;
  margin: 0;
`),ro=oe.div(({theme:i,height:e="60%",collapsed:t})=>`
  position: relative;
  width: 100%;
  height: 0;
  padding: 0;
...
`),no=oe(J)`
  ...
  transform: translate(-50%, -50%);
`,ao=({children:i,collapsable:e=!0,defaultCollapsed:t=!1,placeholder:o,showLink:s=!0,onCollapsedChange:r,...n})=>{let[c,a]=w.useState(!!t),d=s&&"url"in n;return O.createElement(so,null,O.createElement(ro,{collapsed:e&&c,...n},e&&c?O.createElement(no,null,o):i,O.createElement(Ht,{actionItems:[e&&{title:c?"Show":"Hide",onClick:()=>{let l=!c;r&&r(l,c),a(l)}},d&&{title:"Open in new tab",onClick:()=>window.open(n.url,"_blank")}].filter(l=>!!l)})))},U=({placeholder:i,...e})=>O.createElement(ao,{placeholder:i??"Design (Figma)",...e},O.createElement(Tt,{config:{type:"figma",...e}}));oe.div`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
  ...
  overflow: auto;
`;const Ot=({scale:i})=>{const e=Object.keys(i);return u.jsxs(zt,{children:[u.jsx(Ft,{children:u.jsxs("tr",{children:[u.jsx("th",{children:"Size"}),u.jsx("th",{children:"rem"}),u.jsx("th",{children:"px"}),u.jsx("th",{children:"Example"})]})}),u.jsx(It,{children:e.map(t=>u.jsxs("tr",{children:[u.jsx("td",{children:u.jsxs(Dt,{children:["theme.space.",t]})}),u.jsx("td",{children:i[t]/16}),u.jsx("td",{children:i[t]}),u.jsx("td",{children:u.jsx("div",{style:{width:`${i[t]}px`,height:`${i[t]}px`,backgroundColor:Kt("Plus",t)?"#FF79C9":"#0275D8"}})})]},t))})]})};Ot.__docgenInfo={description:"",methods:[],displayName:"SpaceScale"};function dt(i){const e={code:"code",h1:"h1",h2:"h2",li:"li",ol:"ol",p:"p",...ht(),...i.components};return u.jsxs(u.Fragment,{children:[u.jsx(Lt,{title:"Theme/Space"}),`
...
`,u.jsx(U,{url:"https://www.figma.com/file/vnzYfrwIISRYkr2iYE5TcD/Platform-Atoms?node-id=2315%3A736"})]})}function Yo(i={}){const{wrapper:e}={...ht(),...i.components};return e?u.jsx(e,{...i,children:u.jsx(dt,{...i})}):dt(i)}export{Yo as default};
//# sourceMappingURL=space-BT2n_o3o.js.map
