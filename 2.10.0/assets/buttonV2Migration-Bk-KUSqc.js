import{j as e}from"./jsx-runtime-Nms4Y4qS.js";import{useMDXComponents as i}from"./index-DlpNa54Y.js";import{ae as r}from"./index-BxVnAofd.js";import"./index-BwDkhjyp.js";import"./_commonjsHelpers-BosuxZz1.js";import"./iframe-jgdZpc2e.js";import"../sb-preview/runtime.js";import"./index-DhoXBIRq.js";import"./extends-CF3RwP-h.js";import"./isNativeReflectConstruct-lfp1ZYuW.js";import"./inheritsLoose-B6jfs0L0.js";import"./setPrototypeOf-DgZC2w_0.js";import"./index-DF3CPj03.js";import"./index-DrFu-skq.js";const s=""+new URL("button-ex-01-before-DW2HE2cN.png",import.meta.url).href,c=""+new URL("button-ex-01-after-QswVT4Gw.png",import.meta.url).href,a=""+new URL("button-ex-02-before-DhW_ImWf.png",import.meta.url).href,d=""+new URL("button-ex-02-after-BT5OzHP_.png",import.meta.url).href,l=""+new URL("button-ex-03-before-DrDS6Sf0.png",import.meta.url).href,h=""+new URL("button-ex-03-after-DraMTV1O.png",import.meta.url).href,u=""+new URL("button-ex-04-before-kdHV_6U3.png",import.meta.url).href,p=""+new URL("button-ex-04-after-ZKeKZISK.png",import.meta.url).href,x=""+new URL("button-ex-05-before-DuORKXpq.png",import.meta.url).href,m=""+new URL("button-ex-05-after-CwESzPNT.png",import.meta.url).href;function o(t){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...i(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Guides/ButtonV2 migration guide"}),`
...
`,e.jsx("img",{alt:"Correct: the `Link` component is imported and the `as` property is set to `Link` on the button",src:m,width:470}),`
`,e.jsx(n.h3,{id:"button-with-nested-icon",children:"Button with nested icon"}),`
`,e.jsx("img",{alt:"Wrong: example of nested Icon componente inside Button",src:s,width:470}),`
...
`,e.jsx("img",{alt:"Wrong: a React component is used in button label instead of plain string",src:a,width:470}),`
`,e.jsx("img",{alt:"Correct: the button label contains only string and React component is extracted next to it",src:d,width:470}),`
...
`,e.jsx("img",{alt:"Correct: the `iconEnd` property is correctly used and the button label contains only string",src:h,width:470})]})}function C(t={}){const{wrapper:n}={...i(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{C as default};
//# sourceMappingURL=buttonV2Migration-Bk-KUSqc.js.map
