...
`,e.jsx(t.p,{children:"Notice the Current level has lighter color - this one doesn't have 'to' or 'href' defined, so it's inactive."})]})}function A(n={}){const{wrapper:t}={...l(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(r,{...n})}):r(n)}export{A as default};
//# sourceMappingURL=implementingBreadcrumbs-BwXQmf-O.js.map
