import{j as p}from"./jsx-runtime-Nms4Y4qS.js";import{useMDXComponents as pt}from"./index-DlpNa54Y.js";import{az as C,aw as oe,Z as J,aA as E,a as Ht,ae as Lt}from"./index-Dr1C8Baz.js";import{a as ut,r as w,R as O}from"./index-BwDkhjyp.js";import{q as se}from"./styled-components.browser.esm-Dp0SDG1F.js";import{_ as re}from"./_isObject-BZZHHNGj.js";import{g as He,h as zt,d as Ft,e as It}from"./isNotUndefined-BKMziht-.js";import"./index-D97QikPo.js";import{t as Dt}from"./theme-B4UkYPRv.js";import"./iframe-CC5roxI7.js";import"../sb-preview/runtime.js";import"./index-DhoXBIRq.js";import"./_commonjsHelpers-BosuxZz1.js";import"./extends-CF3RwP-h.js";import"./isNativeReflectConstruct-lfp1ZYuW.js";import"./inheritsLoose-B6jfs0L0.js";import"./setPrototypeOf-DgZC2w_0.js";import"./index-DF3CPj03.js";import"./index-DrFu-skq.js";import"./constants-C4Oh6sKJ.js";import"./index-CajKmcpa.js";import"./DSProvider-DOa9IzhU.js";import"./isFunction-DHFK1UxZ.js";import"./prop-BraK_cHP.js";import"./minus-C2f59QhV.js";import"./checkCircleSolid-CXNAtMl8.js";import"./colors-BJBAFLAc.js";var Ut=function(){function i(e,t){this.xf=t,this.n=e}return i.prototype["@@transducer/init"]=He.init,i.prototype["@@transducer/result"]=He.result,i.prototype["@@transducer/step"]=function(e,t){return this.n>0?(this.n-=1,e):this.xf["@@transducer/step"](e,t)},i}(),Vt=re(function(e,t){return new Ut(e,t)}),Yt=re(zt(["drop"],Vt,function(e,t){return Ft(Math.max(0,e),1/0,t)})),Wt=re(function(e,t){return Yt(e>=0?t.length-e:0,t)}),Xt=re(function(i,e){return It(Wt(i.length,e),i)});/**
 * @license
...
`,Se=1e3,Ce=60*Se,ke=60*Ce,W=24*ke,tt=7*W,it=30*W,ot=365*W,zi=[{gte:ot,divisor:ot,unit:"year"},{gte:it,divisor:it,unit:"month"},{gte:tt,divisor:tt,unit:"week"},{gte:W,divisor:W,unit:"day"},{gte:ke,divisor:ke,unit:"hour"},{gte:Ce,divisor:Ce,unit:"minute"},{gte:30*Se,divisor:Se,unit:"seconds"},{gte:0,divisor:1,text:"just now"}],st=i=>(typeof i=="object"?i:new Date(i)).getTime(),Fi=(i,e=Date.now(),t=new Intl.RelativeTimeFormat(void 0,{numeric:"auto"}))=>{const s=st(e)-st(i),r=Math.abs(s);for(const n of zi)if(r>=n.gte){const c=Math.round(Math.abs(s)/n.divisor),a=s<0,d=n.unit;return d?t.format(a?c:-c,d):n.text}},Ii=B`
  .figma-footer {
    flex: 0;
    z-index: calc(var(--z-index) + 1);
...
`,p.jsx(U,{url:"https://www.figma.com/file/vnzYfrwIISRYkr2iYE5TcD/Platform-Atoms?node-id=2315%3A736"})]})}function Wo(i={}){const{wrapper:e}={...pt(),...i.components};return e?p.jsx(e,{...i,children:p.jsx(ht,{...i})}):ht(i)}export{Wo as default};
//# sourceMappingURL=space-Dacmjx_y.js.map
