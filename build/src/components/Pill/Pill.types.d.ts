...
export declare type Variants = typeof PillVariants[keyof typeof PillVariants];
export declare type Sizes = typeof PillSizes[keyof typeof PillSizes];
...
export interface PillRemoveButtonProps extends React.HTMLAttributes<HTMLButtonElement> {
    pillLabel: string;
}
