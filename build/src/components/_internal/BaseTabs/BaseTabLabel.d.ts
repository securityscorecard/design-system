...
export declare const segmentedTabSelected: import("styled-components").FlattenSimpleInterpolation;
declare const BaseTabLabel: import("styled-components").StyledComponent<"div", import("styled-components").DefaultTheme, {
    className: string;
    slot?: string;
