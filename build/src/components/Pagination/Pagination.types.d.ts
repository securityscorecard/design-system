...
export declare type OnPageChangeFn = (page: number) => void;
export declare type customRenderItem = (props: PaginationItemProps & React.HTMLProps<HTMLButtonElement>) => ReactNode;
