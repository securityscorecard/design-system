declare type WithDebouncedSearch = {
    /**
...
declare type WithoutDebouncedSearch = {
    hasDebouncedSearch?: false;
    debounceTime?: never;
};
declare type DebounceProps = WithDebouncedSearch | WithoutDebouncedSearch;
declare type ControlledSearchInputProps = {
    /**
...
declare type UncontrolledSearchInputProps = {
    value?: never;
    onChange?: React.ChangeEventHandler<HTMLInputElement>;
    defaultValue?: string;
} & DebounceProps;
export declare type SearchBarProps = (ControlledSearchInputProps | UncontrolledSearchInputProps) & Omit<React.ComponentPropsWithRef<'input'>, 'disabled'> & {
    /**
