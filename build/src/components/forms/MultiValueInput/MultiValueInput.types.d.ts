...
export interface MultiValueInputProps extends React.InputHTMLAttributes<HTMLInputElement> {
    ...
    onValueAdd?: (addedValues: MultiValueInputProps['value'], nextValues: MultiValueInputProps['value']) => void;
