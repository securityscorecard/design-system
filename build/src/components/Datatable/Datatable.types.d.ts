...
declare type OnDataFetchArgs<D> = {
    pageSize: number;
    pageIndex: number;
...
export declare type BatchActionArgs = [string[], boolean, () => void];
export declare type OnDataFetchFn<D> = ({ pageSize, pageIndex, sortBy, filters, query, }: OnDataFetchArgs<D>) => void;
