declare const Paragraph: import("styled-components").StyledComponent<"span", import("styled-components").DefaultTheme, {
    className: string;
    slot?: string;
...
} & import("../Text/Text.types").TextProps & import("../../../types/spacing.types").SpacingProps & {
    [x: string]: any;
    [x: number]: any;
    [x: symbol]: any;
} & {
