...
export declare type TriggerEvents = typeof DropdownTriggerEvents[keyof typeof DropdownTriggerEvents];
export declare type Placements = typeof DropdownPlacements[keyof typeof DropdownPlacements];
export interface DropdownPaneStyles {
    $isElevated?: boolean;
    $maxWidth: number | 'auto';
}
export declare type DropdownPaneProps = React.PropsWithChildren<{
