...
const useFocusTrap = ({
  ...
  const handleClickOutside = useCallback((event: MouseEvent) => {
    ...
    if (!isActiveRef.current || !trapRef.current) {
  ...
  const activate = useCallback(() => {
    ...
    trapRef.current?.addEventListener('mousedown', handleClickOutside);
    trapRef.current?.addEventListener('click', handleClickOutside);
  ...
  const deactivate = useCallback(() => {
    ...
    trapRef.current?.removeEventListener('mousedown', handleClickOutside);
    trapRef.current?.removeEventListener('click', handleClickOutside);
