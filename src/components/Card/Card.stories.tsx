...
function CardHeaderTemplateWithAdornment() {
  return (
    <CardHeader
      actions={actions}
      leftAdornment={<UserAvatar label="AB" />}
      subtitle="Card subtitle"
      title="Card title"
    />
  );
...
export const WithCardTitleAndAdornment = CardTemplate.bind({});
WithCardTitleAndAdornment.args = {
  ...Playground.args,
  children: (
    <>
      <CardMediaTemplate />
      <CardHeaderTemplateWithAdornment />
      <CardContentTemplate />
    </>
  ),
};
...
export const InteractiveButtonCard = () => (
  <Stack gap="lg">
    <Card onClick={action('card-click')}>
      <CardHeader subtitle="button" title="Interactive card" />
    </Card>
  </Stack>
);

export const InteractiveLinkCard = () => (
  <Stack gap="lg">
    <Card href="/?path=/story/components-card--interactive-link-card">
      <CardHeader subtitle="link" title="Interactive card" />
    </Card>
  </Stack>
);

export const InteractiveCustomLinkCard = () => (
  <Stack gap="lg">
    <Card
      as={CustomLink}
      href="/?path=/story/components-card--interactive-link-card"
    >
      <CardHeader subtitle="custom element" title="Interactive card" />
    </Card>
  </Stack>
);
