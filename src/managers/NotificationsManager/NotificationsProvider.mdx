...
| :----------------- | :------------------------------------- | :-------------------- |
| addNotification    | `(notification: Notification) => void` | Adds new notification |
| updateNotification | `(notification: Notification) => void` | Update notification   |
| removeBanner       | `(id: string) => void`                 | Remove notification   |
