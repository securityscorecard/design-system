...
| :----------- | :---------------------------- | :-------------------------------------------- |
| addBanner    | `(newBanner: Banner) => void` | Adds new banner into the banner stack         |
| removeBanner | `(bannerId: string) => void`  | Remove banner with given ID from banner stack |
...
| addBanner    | `(newBanner: Banner) => void` | Adds new banner into the banner stack         |
| removeBanner | `(bannerId: string) => void`  | Remove banner with given ID from banner stack |
| instances    | `Banner[]`                    | Current banners stack                         |
