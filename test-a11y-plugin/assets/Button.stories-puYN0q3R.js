import{j as a}from"./jsx-runtime-Nms4Y4qS.js";import{a as ve}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{B as t}from"./Button-Y7NUWBaW.js";import"./index-0COcc321.js";import{S as fe}from"./index-iY2rO5S8.js";import"./index-BwDkhjyp.js";import"./_commonjsHelpers-BosuxZz1.js";import"./v4-CQkTLCs1.js";import"./index-CVyJwDg7.js";import"./components-B6h-HAd3.js";import"./styled-components.browser.esm-Dp0SDG1F.js";import"./index-CA8igt89.js";import"./Icon-OPJ4_-kw.js";import"./index-BsP7FXMl.js";import"./index-Dk74W0Oi.js";import"./index-BQWFrAEB.js";import"./constants-CHqWh-7J.js";import"./isNotUndefined-DxARNfZG.js";import"./_isObject-BZZHHNGj.js";import"./slice-DUYrgxkR.js";import"./useLogger-DZJuabeR.js";import"./DSProvider-BQ8JssCJ.js";import"./extends-CF3RwP-h.js";import"./index-DhoXBIRq.js";import"./theme-VOBSdC0d.js";import"./colors-2yNNI7_i.js";import"./index-B2Sxccu3.js";import"./Spinner-h6IgF5Nn.js";import"./prop-qecTCRZr.js";import"./index-CKrVqi-N.js";import"./Padbox-DzmU9-lr.js";import"./Inline.enums-6YASdLRa.js";import"./Cluster-CjJ089XP.js";const Ze={title:"components/ButtonV2/ButtonV2",component:t,args:{onClick:ve("button click"),className:"button"},argTypes:{children:{control:{type:"object"},name:"children",description:"Button label",type:{name:"string | string[]",required:!0}},size:{control:{type:"radio"},options:["sm","md","lg"],name:"size",description:"Sizing variant",table:{type:{summary:"'sm' | 'md' | 'lg'"},defaultValue:{summary:"'md'"}}},variant:{control:{type:"select"},options:["base","highlight","danger","subtle","ghost","highlight-ghost","danger-ghost"],name:"variant",description:"Visual variant of the button",table:{type:{summary:"'base' | 'highlight' | 'danger' | 'subtle' | 'ghost' | 'highlight-ghost' | 'danger-ghost'"},defaultValue:{summary:"'base'"}}},iconStart:{control:{type:"object"},name:"iconStart",description:"Definition of icon that appears before button label",table:{type:{summary:"{ name: IconNames; type?: RegularIconTypes; rotation?: 90 | 180 | 270; }"}}},iconEnd:{control:{type:"object"},name:"iconEnd",description:"Definition of icon that appears after button label",table:{type:{summary:"{ name: IconNames; type?: RegularIconTypes; rotation?: 90 | 180 | 270; }"}}},minWidth:{control:{type:"number"},name:"minWidth",description:"Button minimal width in px. This property is not set by default",table:{type:{summary:"number"}}},isDisabled:{control:{type:"boolean"},name:"isDisabled",description:"Disable the button to prevent clicking",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},isLoading:{control:{type:"boolean"},name:"isLoading",description:"Display loading spinner and disable button to prevent clicking",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},loadingText:{control:{type:"text"},name:"loadingText",description:"Text displayed next to spinner in loading state",table:{type:{summary:"string"},defaultValue:{summary:"'Loading'"}}},isExpanded:{control:{type:"boolean"},name:"isExpanded",description:"Expands button to full width of the parrent component",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},as:{control:{type:"object"},name:"as",description:"Used to type-safe property inference. By default `button` element is used, other common options will be `a` or `Link` from react-router",table:{type:{summary:"Element"}}}},parameters:{docs:{description:{component:"A Button is a fundamental interactive element in user interfaces,\nallowing users to trigger actions or navigate through an application. It serves\nas a clear call-to-action, prompting user engagement and facilitating task\ncompletion.\n\n```js\nimport { ButtonV2 } from '@securityscorecard/design-system';\n```\n## Using as links and with external routers\n\nIn `ButtonV2`, you must now explicitly define the element to be rendered using the `as` prop. The default value for `as` is `button`, but you can now pass in `a` or a custom React component (like `Link` from react-router-dom) to render the appropriate element.\nThis increases type-safety, as the component can correctly infer the available props based on the `as` value.\n\n## Coming from original Button component?\nWe prepared a comprehensive [migration guide](?path=/docs/guides-buttonv2-migration-guide--documentation) that should cover all main differences and help you with this transition."}}}},s={args:{children:"Button",size:"md",variant:"base"},parameters:{screenshot:{skip:!0}}},e={args:{children:"Button",size:"md",variant:"base"},parameters:{screenshot:{variants:{hovered:{hover:"button.button"},focused:{focus:"button.button"}}}}},r={args:{...e.args,variant:"subtle"},parameters:{screenshot:{variants:{hovered:{hover:"button.button"},focused:{focus:"button.button"}}}}},o={args:{...e.args,variant:"ghost"},parameters:{screenshot:{variants:{hovered:{hover:"button.button"},focused:{focus:"button.button"}}}}},i={args:{...e.args,variant:"highlight"},parameters:{screenshot:{variants:{hovered:{hover:"button.button"},focused:{focus:"button.button"}}}}},c={args:{...e.args,variant:"danger"},parameters:{screenshot:{variants:{hovered:{hover:"button.button"},focused:{focus:"button.button"}}}}},m={args:{...e.args,variant:"danger-ghost"},parameters:{screenshot:{variants:{hovered:{hover:"button.button"},focused:{focus:"button.button"}}}}},u={args:{...e.args,size:"sm"}},d={args:{...e.args,size:"md"}},p={args:{...e.args,size:"lg"}},l={args:{...e.args,isExpanded:!0}},g={args:{...e.args,isDisabled:!0}},b={args:{...e.args,isLoading:!0}},h={args:{...e.args,minWidth:200}},v={args:{...e.args,iconStart:{name:"cog"}}},f={args:{...e.args,iconEnd:{name:"angle-down"}}},y={args:{children:"Button",iconStart:{name:"cog"},iconEnd:{name:"angle-down"}},render:n=>a.jsxs(fe,{gap:"md",children:[a.jsx(t,{className:"button",size:"sm",variant:"base",isDisabled:!0,...n}),a.jsx(t,{className:"button",size:"sm",variant:"highlight",isDisabled:!0,...n}),a.jsx(t,{className:"button",size:"sm",variant:"danger",isDisabled:!0,...n}),a.jsx(t,{className:"button",size:"sm",variant:"subtle",isDisabled:!0,...n}),a.jsx(t,{className:"button",size:"sm",variant:"ghost",isDisabled:!0,...n}),a.jsx(t,{className:"button",size:"sm",variant:"danger-ghost",isDisabled:!0,...n}),a.jsx(t,{className:"button",size:"sm",variant:"highlight-ghost",isDisabled:!0,...n})]}),tags:["!dev","!autodocs"]};var V,B,S;s.parameters={...s.parameters,docs:{...(V=s.parameters)==null?void 0:V.docs,source:{originalSource:`{
...
}`,...(M=(G=c.parameters)==null?void 0:G.docs)==null?void 0:M.source}}};var R,C,P;m.parameters={...m.parameters,docs:{...(R=m.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
    ...VariantBase.args,
...
}`,...(P=(C=m.parameters)==null?void 0:C.docs)==null?void 0:P.source}}};var U,_,q;u.parameters={...u.parameters,docs:{...(U=u.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
    ...VariantBase.args,
    size: 'sm'
  }
}`,...(q=(_=u.parameters)==null?void 0:_.docs)==null?void 0:q.source}}};var A,O,F;d.parameters={...d.parameters,docs:{...(A=d.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    ...VariantBase.args,
    size: 'md'
  }
...
}`,...(ie=(oe=h.parameters)==null?void 0:oe.docs)==null?void 0:ie.source}}};var ce,me,ue;v.parameters={...v.parameters,docs:{...(ce=v.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  args: {
    ...VariantBase.args,
    iconStart: {
      name: 'cog'
...
}`,...(ue=(me=v.parameters)==null?void 0:me.docs)==null?void 0:ue.source}}};var de,pe,le;f.parameters={...f.parameters,docs:{...(de=f.parameters)==null?void 0:de.docs,source:{originalSource:`{
  args: {
    ...VariantBase.args,
    iconEnd: {
      name: 'angle-down'
  ...
  tags: ['!dev', '!autodocs']
}`,...(he=(be=y.parameters)==null?void 0:be.docs)==null?void 0:he.source}}};const $e=["Playground","VariantBase","VariantSubtle","VariantGhost","VariantHighlight","VariantDanger","VariantDangerGhost","SizeSmall","SizeMedium","SizeLarge","IsExpanded","IsDisabled","IsLoading","HasMinWidth","HasIconStart","HasIconEnd","VisualTestsDisabled"];export{f as HasIconEnd,v as HasIconStart,h as HasMinWidth,g as IsDisabled,l as IsExpanded,b as IsLoading,s as Playground,p as SizeLarge,d as SizeMedium,u as SizeSmall,e as VariantBase,c as VariantDanger,m as VariantDangerGhost,o as VariantGhost,i as VariantHighlight,r as VariantSubtle,y as VisualTestsDisabled,$e as __namedExportsOrder,Ze as default};
//# sourceMappingURL=Button.stories-puYN0q3R.js.map
