import{j as p}from"./jsx-runtime-Cw0GR0a5.js";import{useMDXComponents as pt}from"./index-DSkyVWTJ.js";import{av as C,as as oe,I as J,aw as E,X as Lt,ae as zt}from"./index-QPajMEvj.js";import{a as ut,r as w,R as O}from"./index-CTjT7uj6.js";import{q as se}from"./styled-components.browser.esm-CkXiwQaI.js";import{_ as re}from"./_isObject-BZZHHNGj.js";import{d as He,f as It,e as Ft}from"./space.enums-aJQ33HT_.js";import{s as Dt}from"./slice-CaMqkvGm.js";import"./index-BkLmc-fh.js";import{t as Ut}from"./theme-VOBSdC0d.js";import"./iframe-awgemxr7.js";import"../sb-preview/runtime.js";import"./index-DIVhMF2i.js";import"./extends-CF3RwP-h.js";import"./isNativeReflectConstruct-lfp1ZYuW.js";import"./inheritsLoose-B6jfs0L0.js";import"./setPrototypeOf-DgZC2w_0.js";import"./index-CgFWNHQ8.js";import"./index-DrFu-skq.js";import"./constants-CgU6e_L6.js";import"./index-BsP7FXMl.js";import"./DSProvider-DZ2BDZS9.js";import"./minus-rUvolOxF.js";import"./checkCircleSolid-D_DFWg_A.js";import"./colors-2yNNI7_i.js";var Vt=function(){function i(e,t){this.xf=t,this.n=e}return i.prototype["@@transducer/init"]=He.init,i.prototype["@@transducer/result"]=He.result,i.prototype["@@transducer/step"]=function(e,t){return this.n>0?(this.n-=1,e):this.xf["@@transducer/step"](e,t)},i}(),Yt=re(function(e,t){return new Vt(e,t)}),Wt=re(It(["drop"],Yt,function(e,t){return Dt(Math.max(0,e),1/0,t)})),Xt=re(function(e,t){return Wt(e>=0?t.length-e:0,t)}),Zt=re(function(i,e){return Ft(Xt(i.length,e),i)});/**
 * @license
...
`,Se=1e3,Ce=60*Se,ke=60*Ce,W=24*ke,tt=7*W,it=30*W,ot=365*W,Ii=[{gte:ot,divisor:ot,unit:"year"},{gte:it,divisor:it,unit:"month"},{gte:tt,divisor:tt,unit:"week"},{gte:W,divisor:W,unit:"day"},{gte:ke,divisor:ke,unit:"hour"},{gte:Ce,divisor:Ce,unit:"minute"},{gte:30*Se,divisor:Se,unit:"seconds"},{gte:0,divisor:1,text:"just now"}],st=i=>(typeof i=="object"?i:new Date(i)).getTime(),Fi=(i,e=Date.now(),t=new Intl.RelativeTimeFormat(void 0,{numeric:"auto"}))=>{const s=st(e)-st(i),r=Math.abs(s);for(const n of Ii)if(r>=n.gte){const c=Math.round(Math.abs(s)/n.divisor),a=s<0,d=n.unit;return d?t.format(a?c:-c,d):n.text}},Di=B`
  .figma-footer {
    flex: 0;
    z-index: calc(var(--z-index) + 1);
...
`,p.jsx(U,{url:"https://www.figma.com/file/vnzYfrwIISRYkr2iYE5TcD/Platform-Atoms?node-id=2315%3A736"})]})}function Vo(i={}){const{wrapper:e}={...pt(),...i.components};return e?p.jsx(e,{...i,children:p.jsx(ht,{...i})}):ht(i)}export{Vo as default};
//# sourceMappingURL=space-PtVzzES4.js.map
